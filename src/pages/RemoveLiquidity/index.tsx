...
import { Currency, currencyEquals, ETHER, Percent } from '@nguyenphu27/sdk'
...
export default function RemoveLiquidity({
    ...
    return (
      <AutoColumn gap="md" style={{ marginTop: '20px' }}>
        <RowBetween align="flex-end">
          <Text color='black' fontSize="24px">{parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)}</Text>
          <RowFixed gap="4px">
            <CurrencyLogo currency={currencyA} size="24px" />
            <Text color='black' fontSize="24px" style={{ marginLeft: '10px' }}>
              {currencyA?.symbol}
            </Text>
          </RowFixed>
        </RowBetween>
        ...
        <RowBetween align="flex-end">
          <Text color='black' fontSize="24px">{parsedAmounts[Field.CURRENCY_B]?.toSignificant(6)}</Text>
          <RowFixed gap="4px">
        ...
        <Text small color="black" textAlign="left" padding="12px 0 0 0" style={{ fontStyle: 'italic' }}>
  ...
  function modalBottom() {
    return (
      <>
        <RowBetween>
          <Text color="black">{`LP ${currencyA?.symbol}/${currencyB?.symbol}`} Burned</Text>
          <RowFixed>
        ...
        {pair && (
          <>
            <RowBetween>
              <Text color="black">{TranslateString(1182, 'Price')}</Text>
              <Text>
        ...
        <Button style={{backgroundColor:'#0FD17A',color:'white'}} disabled={!(approval === ApprovalState.APPROVED || signatureData !== null)} onClick={onRemove}>
              ...
              <>
                ...
                <Body>
                  <OutlineCard>
                    <AutoColumn gap="10px">
                      <RowBetween>
                        <Text color='black' fontSize="24px">{formattedAmounts[Field.CURRENCY_A] || '-'}</Text>
                        <RowFixed>
                          <CurrencyLogo currency={currencyA} style={{ marginRight: '12px' }} />
                          <Text color='black' fontSize="24px" id="remove-liquidity-tokena-symbol">
                            {currencyA?.symbol}
                          </Text>
                        </RowFixed>
                      </RowBetween>
                      <RowBetween>
                        <Text color='black' fontSize="24px">{formattedAmounts[Field.CURRENCY_B] || '-'}</Text>
                        <RowFixed>
                          <CurrencyLogo currency={currencyB} style={{ marginRight: '12px' }} />
                          <Text color='black' fontSize="24px" id="remove-liquidity-tokenb-symbol">
                            {currencyB?.symbol}
                          </Text>
                        </RowFixed>
                      </RowBetween>
