  ...
  return (
    <Container>
      ...
      <AppBody>
        ...
        <CardBody >
          <AutoColumn gap="md">
            <Button style={{backgroundColor:'#0FD17A'}}
              onClick={() => {
                setShowSearch(true)
            ...
            {hasPosition && (
              ...
              >
                <Text style={{ textAlign: 'center',color:'black' }}>{TranslateString(210, 'Pool found!')}</Text>
              </ColumnCenter>
            )}
            ...
            {currency0 && currency1 ? (
              pairState === PairState.EXISTS ? (
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    <Text style={{ textAlign: 'center' ,color:'black'}}>{TranslateString(214, 'No pool found.')}</Text>
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    <Text style={{ textAlign: 'center',color:'black' }}>{TranslateString(136, 'Invalid pair.')}</Text>
                  </AutoColumn>
                </LightCard>
