  ...
  return (
    <Container >
      ...
      <AppBody   >
        ...
        >
          <Button style={{backgroundColor:'#0FD17A' , color:'white'}} id="join-pool-button" as={Link} to="/add/BNB">
        ...
        <AutoColumn gap="lg" justify="center">
          <CardBody>
            <AutoColumn gap="12px" style={{ width: '100%' }}>
              ...
              <div>
                <Text fontSize="14px" style={{ padding: '.5rem 0 .5rem 0',color:'black' }}>
                  {TranslateString(106, "Don't see a pool you joined?")}{' '}
                  <StyledInternalLink style={{color:'#0FD17A'}} id="import-pool-link" to="/find">
