...
import { Currency, currencyEquals, ETHER, TokenAmount } from '@nguyenphu27/sdk'
    ...
    return noLiquidity ? (
      <AutoColumn gap="20px">
        <LightCard mt="20px" borderRadius="20px">
          <RowFlat>
            <UIKitText color='black' fontSize="48px" mr="8px">
      ...
      <AutoColumn gap="20px">
        ...
        <Row>
          <UIKitText color='black' fontSize="24px">
            {`${currencies[Field.CURRENCY_A]?.symbol}/${currencies[Field.CURRENCY_B]?.symbol} Pool Tokens`}
          </UIKitText>
        </Row>
        <UIKitText  small textAlign="left" padding="8px 0 0 0 " style={{ fontStyle: 'italic' ,color:'black'}}>
            ...
            <AutoColumn gap="20px">
              {noLiquidity && (
                <ColumnCenter>
                  <Pane>
                    <AutoColumn gap="12px">
                      <UIKitText color='black'>{TranslateString(1158, 'You are the first liquidity provider.')}</UIKitText>
                    ...
                    isValid && (
                      <RowBetween>
                        {approvalA !== ApprovalState.APPROVED && (
                          ...
                          >
                            {approvalA === ApprovalState.PENDING ? (
                              <Dots color='black'>Approving {currencies[Field.CURRENCY_A]?.symbol}</Dots>
                            ) : (
                        ...
                        {approvalB !== ApprovalState.APPROVED && (
                          ...
                          >
                            {approvalB === ApprovalState.PENDING ? (
                              <Dots color='black'>Approving {currencies[Field.CURRENCY_B]?.symbol}</Dots>
                            ) : (
