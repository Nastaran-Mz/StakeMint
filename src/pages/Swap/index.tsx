                  ...
                  <AutoColumn gap="4px">
                    {Boolean(trade) && (
                      <RowBetween align="center">
                        <Text color="black" fontSize="14px">{TranslateString(1182, 'Price')}</Text>
                        <TradePrice
                    ...
                    {allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (
                      <RowBetween align="center">
                        <Text color="black" fontSize="14px">{TranslateString(88, 'Slippage Tolerance')}</Text>
                        <Text color="black" fontSize="14px">{allowedSlippage / 100}%</Text>
                      </RowBetween>
                    )}
                  </AutoColumn>
                </Card>
            ...
            <BottomGrouping>
              {!account ? (
                ...
                <GreyCard style={{ textAlign: 'center'}}>
                  <Text color='black' mb="4px">{TranslateString(1194, 'Insufficient liquidity for this trade.')}</Text>
                </GreyCard>
              ) : showApproveFlow ? (
                <RowBetween>
                  <Button
                    ...
                    style={{ width: '48%', backgroundColor:'#0FD17A'}}
