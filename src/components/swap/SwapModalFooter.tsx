    ...
    <>
      <AutoColumn gap="0px">
        <RowBetween align="center">
          <Text color='black' fontSize="14px">Price</Text>
          <Text
            fontSize="14px"
            style={{
        ...
        <RowBetween>
          ...
          <RowFixed>
            ...
            <Text color='black' fontSize="14px" marginLeft="4px">
              {trade.tradeType === TradeType.EXACT_INPUT
        ...
        <RowBetween>
          <RowFixed>
            <Text color='black' fontSize="14px">{TranslateString(226, 'Price Impact')}</Text>
            <QuestionHelper
        ...
        <RowBetween>
          <RowFixed>
            <Text color='black' fontSize="14px">{TranslateString(228, 'Liquidity Provider Fee')}</Text>
            <QuestionHelper
              text={TranslateString(
                999,
