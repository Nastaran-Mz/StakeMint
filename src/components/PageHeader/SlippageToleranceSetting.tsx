  ...
  return (
    <Box mb="16px" >
      <Flex alignItems="center" mb="8px">
        <Text color='black' bold>{translateString(88, 'Slippage tolerance')}</Text>
        <QuestionHelper
      ...
      <Options >
          ...
          {predefinedValues.map(({ label, value: predefinedValue }) => {
            ...
            return (
              <Option key={predefinedValue}>
                <Button style={{backgroundColor:'#E4E4E4',color:'#0FD17A'}} variant={value === predefinedValue ? 'primary' : 'tertiary'} onClick={handleClick}>
                  {label}
                </Button>
              </Option>
            )
        ...
        <Flex alignItems="center">
          <Option>
            <Input style={{backgroundColor:'#E4E4E4',color:'#0FD17A'}}
              type="number"
              scale="lg"
              step={0.1}
              min={0.1}
          ...
          <Option>
            <Text color='#0FD17A' fontSize="18px">%</Text>
          </Option>
        </Flex>
      </Options>
      {error && (
