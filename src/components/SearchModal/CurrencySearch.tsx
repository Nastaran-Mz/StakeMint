    ...
    <Column style={{ width: '100%', flex: '1 1' }}>
      <PaddedColumn gap="14px">
        <RowBetween>
          ...
          <CloseIcon color='black' onClick={onDismiss} />
        </RowBetween>
        <SearchInput
          type="text"
        ...
        <RowBetween>
          <Text color='black' fontSize="15px">{TranslateString(126, 'Token name')}</Text>
            ...
            <RowBetween>
              {selectedListInfo.current ? (
                <Row>
                  ...
                  <Text color='black' id="currency-search-selected-list-name">{selectedListInfo.current.name}</Text>
                </Row>
              ) : null}
              <LinkStyledButton
