        ...
        <UIKitCard>
          <CardBody>
            <AutoColumn gap="12px">
              <FixedHeightRow>
                <RowFixed>
                  <Text style={{ textTransform: 'uppercase', fontWeight: 600 }} fontSize="14px" color="black">
              ...
              <FixedHeightRow onClick={() => setShowMore(!showMore)}>
                ...
                <RowFixed>
                  <Text color='black' fontSize="14px">{userPoolBalance ? userPoolBalance.toSignificant(4) : '-'}</Text>
                </RowFixed>
              </FixedHeightRow>
              <AutoColumn gap="4px">
                <FixedHeightRow>
                  <Text color='black' fontSize="14px">{currency0.symbol}:</Text>
                  {token0Deposited ? (
                    <RowFixed>
                      <Text color='black' ml="6px" fontSize="14px">
                ...
                <FixedHeightRow>
                  <Text color='black' fontSize="14px">{currency1.symbol}:</Text>
                  {token1Deposited ? (
                    <RowFixed>
                      <Text color='black' ml="6px" fontSize="14px">
            ...
            <RowBetween marginTop="10px">
              {removeOnly && (
                <Button
                  ...
                  style={{ width: '48%' ,backgroundColor:'#0FD17A',color:'white'}}
                >
                  Add
                </Button>
              )}
